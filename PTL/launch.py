...
class baseparser(HyperOptArgumentParser):
    def __init__(self,*args,strategy="random_search",**kwargs):
        ...
        self.opt_list("--method", type=str, default="flat", tunable=True)
        self.opt_list("--window_size", type=int, default=120, tunable=True) #The number of minutes each snapshot represents
        ...
        self.argNames=["dir","learning_rate","batch_size","precision","accelerator","num_trials"]
    def __dict__(self):
